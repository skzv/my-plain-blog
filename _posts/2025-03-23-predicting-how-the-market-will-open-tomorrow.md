...
To relate the futures price to the current fair value being priced by the futures market, we have to account for the time between now the future expiry date.
